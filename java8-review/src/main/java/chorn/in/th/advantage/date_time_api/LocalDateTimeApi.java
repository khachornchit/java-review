package chorn.in.th.advantage.date_time_api;
...
public class LocalDateTimeApi {
    ...
    public static void testBackwardCompatability() {
        //Get the current date
        Date legacyCurrentDate = new Date();
        System.out.println("Current date: " + legacyCurrentDate);

        //Get the instant of current date in terms of milliseconds
        Instant now = legacyCurrentDate.toInstant();
